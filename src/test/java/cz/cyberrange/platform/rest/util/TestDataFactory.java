...
public class TestDataFactory {
  ...
  public List<OverallPhaseStatistics> getOverallPhaseStatisticsAllWrong() {
    ...
    overallPhaseStatistics.setWrongAnswers(
        List.of("wrong", "completely wrong", "not even close", "false", "far far away"));
  ...
  public AdaptiveSmartAssistantInput getAdaptiveSmartAssistantInput1() {
    ...
    adaptiveSmartAssistantInput.setDecisionMatrix(
        List.of(getDecisionMatrixRowOnlyQuestionnaireMatters()));
  ...
  public AdaptiveSmartAssistantInput getAdaptiveSmartAssistantInput2() {
    ...
    adaptiveSmartAssistantInput.setDecisionMatrix(
        List.of(
            getDecisionMatrixRowOnlyQuestionnaireMatters(),
            getDecisionMatrixRowEverythingMatters()));
    return adaptiveSmartAssistantInput;
  }
  ...
  public AdaptiveSmartAssistantInput getAdaptiveSmartAssistantInput4() {
    ...
    adaptiveSmartAssistantInput.setDecisionMatrix(
        List.of(
            getDecisionMatrixRowOnlyQuestionnaireMatters(),
            getDecisionMatrixRowEverythingMattersInDifferentWeights()));
    return adaptiveSmartAssistantInput;
  }
  ...
  private RelatedPhaseInfoDTO getRelatedPhaseInfo(
      Long phaseId, int estimatedTime, boolean correctlyAnsweredRelatedQuestions) {
