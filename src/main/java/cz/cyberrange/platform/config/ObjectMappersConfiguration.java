...
public class ObjectMappersConfiguration {
  ...
  /**
   * Object mapper bean used in restTemplate calls. Basically, it contains validator settings to
   * validate object in deserialization phase using Bean Validations.
   *
   * @return the object mapper
   */
