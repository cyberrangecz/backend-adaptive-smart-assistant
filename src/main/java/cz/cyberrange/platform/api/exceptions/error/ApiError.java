...
@ApiModel(
    value = "ApiError",
    subTypes = {ApiEntityError.class},
    description = "Superclass for classes ApiEntityError and ApiMicroserviceError")
@JsonSubTypes({@JsonSubTypes.Type(value = ApiEntityError.class, name = "ApiEntityError")})
...
public class ApiError {
  ...
  @ApiModelProperty(
      ...
      example = "/rest-user-and-group/api/v1/groups/1000 (different for each type of exception).")
  private String path;
